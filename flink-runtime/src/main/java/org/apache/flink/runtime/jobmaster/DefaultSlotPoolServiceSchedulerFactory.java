...
import org.apache.flink.runtime.scheduler.FCFSSchedulerFactory;
import org.apache.flink.runtime.scheduler.LoadAwareSchedulerFactory;
import org.apache.flink.runtime.scheduler.RLSchedulerFactory;
...
import org.apache.flink.runtime.scheduler.strategy.LoadAwareSchedulingStrategy;
import org.apache.flink.runtime.scheduler.strategy.LoadAwareSchedulingStrategyFactory;
    ...
    public static DefaultSlotPoolServiceSchedulerFactory fromConfiguration(
        ...
        switch (schedulerType) {
            ...
            case AdaptiveBatch:
                ...
                break;
            case FCFS:
                schedulerNGFactory = new FCFSSchedulerFactory();
                slotPoolServiceFactory =
                        new DeclarativeSlotPoolServiceFactory(
                                SystemClock.getInstance(),
                                slotIdleTimeout,
                ...
                break;
            case RL:
                schedulerNGFactory = new RLSchedulerFactory();
                slotPoolServiceFactory =
                        new DeclarativeSlotPoolServiceFactory(
                                SystemClock.getInstance(),
                                slotIdleTimeout,
                ...
                break;
            case LoadStream:
                schedulerNGFactory = new LoadAwareSchedulerFactory();
                slotPoolServiceFactory =
                        new DeclarativeSlotPoolServiceFactory(
                                SystemClock.getInstance(),
                                slotIdleTimeout,
